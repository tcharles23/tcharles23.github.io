...
_.last = function(array, number) {
    ...
    // console.log(array.slice(array, number));
...
_.indexOf = function(array, value) {
 ...
 // return -1 
     ...
     // if array includes a value more than once
...
// if its an array callback on the the element, it's index, <collection>
...
_.partition = function(array, func) {
    ...
    finalArr.push(truArr);
    finalArr.push(falArr);
...
_.pluck = function(collection, property) {
    ...
    _.map(collection, function(e, key, collection){
        // console.log(array[e]);
    
    
        propArr.push(e[property]);
...
_.some = function(collection, func) {
    let filterThru = _.filter(collection, function(e, i, collection) {
        if(func === undefined) {
            if(e) {
                return true;
            }
    ...
    for(let i = 0; i < filterThru.length; i++) {
        if(filterThru[i]) {
          return true;  
        }
    }
...
_.extend = function(obj, ...objs) {
   _.each(objs, function(objects, i, collection) {
